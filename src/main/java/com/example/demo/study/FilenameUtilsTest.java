...
/**
 * @Description: FilenameUtils工具类笔记
 * @Author: crx
 * @Create: 14:14 2020/8/11
 */
public class FilenameUtilsTest {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("(29)判断文件扩展名是否包含在指定字符串数组中:"
                + FilenameUtils.isExtension(fileFullName, new String[]{"txt", "jpg"}));
        ...
        System.out.println("resources路径" + ResourceUtils.getURL("classpath:").getPath());
