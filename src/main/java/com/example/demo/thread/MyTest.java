...
public class MyTest {
    ...
    private ExecutorService executor = Executors.newFixedThreadPool(15);// 创建固定个数线程
    private ExecutorService executor3 = Executors.newSingleThreadExecutor();// 创建单个线程
    private ExecutorService executor2 = Executors.newCachedThreadPool();// 创建动态线程（自适应大小）
    private ExecutorService executor4 = Executors.newScheduledThreadPool(15);// 创建定时线程
